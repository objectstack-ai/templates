  ...
  objects: {
    helpdesk_ticket: {
      ...
      _views: {
        ...
        breaching_tickets: {
          label: 'Breaching SLA',
          description: 'Past resolution_due_at and still open',
        },
    ...
    helpdesk_customer: {
      ...
      fields: {
        ...
        locale: { label: 'Preferred Locale' },
        portal_user: { label: 'Portal User' },
    ...
    helpdesk_team: {
      ...
      fields: {
        ...
        specialty: {
          label: 'Specialty',
          options: {
            tier1: 'Tier 1 — General',
            tier2: 'Tier 2 — Technical',
            billing: 'Billing',
    ...
    helpdesk_kb_article: {
      ...
      fields: {
        ...
        unhelpful_count: { label: 'Unhelpful Votes' },
    ...
    helpdesk_message: {
      ...
      fields: {
        ...
        direction: {
          label: 'Direction',
          options: { inbound: 'Inbound', outbound: 'Outbound', internal_note: 'Internal Note' },
        },
        author_user: { label: 'Author (User)' },
        author_customer: { label: 'Author (Customer)' },
        body: { label: 'Body' },
        is_ai_drafted: { label: 'AI Drafted' },
