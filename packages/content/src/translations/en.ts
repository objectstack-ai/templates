...
export const en: TranslationData = {
  ...
  dashboards: {
    ...
    roi_by_channel_dashboard: {
      ...
      actions: {},
      widgets: {
        total_views_90d: { title: 'Views (90d)', description: 'Sum of total_views across publications updated in last 90 days' },
        total_clicks_90d: { title: 'Clicks (90d)', description: 'Sum of total_clicks across publications updated in last 90 days' },
        total_signups_90d: { title: 'Signups (90d)', description: 'Sum of total_signups across publications updated in last 90 days' },
        total_revenue_90d: { title: 'Revenue (90d)', description: 'Sum of total_revenue across publications updated in last 90 days' },
