...
export const zhCN: TranslationData = {
  ...
  dashboards: {
    ...
    roi_by_channel_dashboard: {
      ...
      actions: {},
      widgets: {
        total_views_90d: { title: '近 90 天浏览', description: '近 90 天有度量更新的发布的浏览总和' },
        total_clicks_90d: { title: '近 90 天点击', description: '近 90 天有度量更新的发布的点击总和' },
        total_signups_90d: { title: '近 90 天注册', description: '近 90 天有度量更新的发布的注册总和' },
        total_revenue_90d: { title: '近 90 天收入', description: '近 90 天有度量更新的发布的收入总和' },
