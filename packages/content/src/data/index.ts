...
const signals = defineDataset(Signal, {
  ...
  records: [
    ...
    },
    {
      ...
      status: 'promoted',
      impact: 'medium',
      summary: 'Multiple +1s. Two paying customers chimed in. Cheap to ship as a small RSS endpoint.',
...
const ctas = defineDataset(Cta, {
  ...
  records: [
    ...
    { piece: 'Honest comparison: us vs Helio', label_text: 'Start free trial', goal: 'signup', destination_url: 'https://example.com/signup?utm_content=us-vs-helio', variant: 'us-vs-helio-default', is_primary: true },
    { piece: 'A short anatomy of a great launch week', label_text: 'Subscribe for launch recaps', goal: 'subscribe', destination_url: 'https://example.com/newsletter?utm_content=launch-week', variant: 'launch-week-default', is_primary: true },
    { piece: 'Five anti-patterns we keep seeing in dashboards', label_text: 'Audit your dashboard', goal: 'demo', destination_url: 'https://example.com/audit?utm_content=anti-patterns', variant: 'anti-patterns-default', is_primary: true },
    { piece: 'The marketing metrics dashboard we actually use', label_text: 'See the template', goal: 'read', destination_url: 'https://example.com/templates/metrics?utm_content=mkt-dash', variant: 'mkt-dash-default', is_primary: true },
    { piece: 'Picking the right region — a 3-minute guide', label_text: 'Open docs', goal: 'read', destination_url: 'https://docs.example.com/regions?utm_content=region-guide', variant: 'region-guide-default', is_primary: true },
    { piece: 'Customer story: Northwind cut report time from 3 days to 4 hours', label_text: 'Book a demo', goal: 'demo', destination_url: 'https://example.com/demo?utm_content=northwind', variant: 'northwind-default', is_primary: true },
    { piece: 'How our SOC 2 program actually works (and where the report lives)', label_text: 'Book a security review', goal: 'demo', destination_url: 'https://example.com/security-review?utm_content=soc2', variant: 'soc2-default', is_primary: true },
    { piece: 'What it actually costs to run our analytics stack', label_text: 'Get the cost calculator', goal: 'signup', destination_url: 'https://example.com/cost-calculator?utm_content=stack-cost', variant: 'stack-cost-default', is_primary: true },
    { piece: 'Introducing the changelog RSS feed', label_text: 'Add the feed', goal: 'subscribe', destination_url: 'https://example.com/changelog.xml', variant: 'changelog-default', is_primary: true },
    { piece: 'Weekly: Issue #42 — Two ways to think about region selection', label_text: 'Read the full guide', goal: 'read', destination_url: 'https://example.com/blog/choose-region', variant: 'newsletter-42-default', is_primary: true },
    { piece: 'Weekly: Issue #43 — What we shipped this week', label_text: 'See the changelog', goal: 'read', destination_url: 'https://example.com/changelog', variant: 'newsletter-43-default', is_primary: true },
    { piece: 'Why we kept the demo gate (and when we will drop it)', label_text: 'Start free trial', goal: 'signup', destination_url: 'https://example.com/signup?utm_content=demo-gate', variant: 'demo-gate-default', is_primary: true },
    { piece: 'How we decide what makes the public roadmap', label_text: 'See the roadmap', goal: 'read', destination_url: 'https://example.com/roadmap?utm_content=criteria-post', variant: 'roadmap-default', is_primary: true },
    { piece: 'Q3 2025 metrics: what worked, what didn\u2019t', label_text: 'Subscribe to Q4 recap', goal: 'subscribe', destination_url: 'https://example.com/newsletter?utm_content=q3-recap', variant: 'q3-default', is_primary: true },
  ],
});
