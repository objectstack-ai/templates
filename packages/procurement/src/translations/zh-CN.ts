...
export const zhCN: TranslationData = {
  ...
  dashboards: {
    spend_at_a_glance_dashboard: {
      ...
      widgets: {
        awaiting_approval: { title: '待审批申请', description: '金额超过审批阈值的已提交采购申请' },
        open_pos: { title: '在途采购订单', description: '已发送或部分到货的采购订单' },
        overdue_pos: { title: '逾期到货', description: '已过预计到货日的在途采购订单' },
        open_commitment: { title: '在途承诺金额', description: '在途采购订单的金额合计' },
        pending_requests_table: { title: '待审批申请', description: '按金额排序的已提交采购申请' },
        open_pos_table: { title: '在途采购订单', description: '按预计到货日排序的在途采购订单' },
        po_value_by_month: { title: '按月采购订单金额（近 12 个月）' },
        top_vendors_by_spend: { title: '按支出排名的供应商' },
      },
    },
  },
};
